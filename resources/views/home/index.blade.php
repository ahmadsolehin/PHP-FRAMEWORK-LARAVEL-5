...
<button type="button" id="insert" class="btn btn-success">Insert</button>
 ...
 <table class="table">
    <thead class="thead-dark">
		...
		<tr>
			<td>Name :</td>
			<td><input type="text" class="form-control" name="upname" /></td>
		</tr>
		<tr>
			<td>Age :</td>
			<td><input type="text" class="form-control" name="upage" /></td>
		</tr>
		<tr>
			<td>Email</td>
			<td><input type="text" class="form-control" name="upemail" /></td>
		</tr>
		<tr>
			<td>Address</td>
			<td><input type="text" class="form-control" name="upaddress" /></td>
		</tr>
		<tr>
			<td colspan="2">
	...
	<table class="table">
		...
		<tr>
			<td>Select Id:</td>
			<td>
				<select class="form-control" name="upid" id="delid">
					@foreach($member as $value)
					<option value="{{ $value->id}}"> {{ $value->id }} </option>
					@endforeach
				</select>
